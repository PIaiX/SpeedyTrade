...
export const getLotsByCategoryRegionAndParams = async (regionId, categoryId, params) => {
    try {
        const response = await $api.get(
            `${apiRoutes.LOTS_ACTIONS}?regionId=${regionId}&categoryId=${categoryId}&page=1&limit=10`,
            {
