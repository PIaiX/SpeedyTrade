                    ...
                    <Row className='gx-4 gy-5'>
                        <Col xs={12} lg={7}>
                            ...
                            <Row className='g-3 g-sm-4'>
                                ...
                                <Col md={9}>
                                    <div className='box'>
                                        <p>ProjectSuperEssence.net Top Rang Step - Season 3, l8k-2568, Прочее, Без ранга, 150 шт., Avatar</p>
                                    </div>
                                </Col>
                                ...
                                <Col md={9}>
                                    <div className='box'>
                                        <p>ProjectSuperEssence.net Top Rang Step - Season 3, l8k-2568, Прочее, Без ранга, 150 шт., Avatar</p>
                                        <p>366M - силы
                                        <br/>383 - уровень героев
                                        <br/>34 - возвышенных героев
                                        <br/>6 - героев иномирцев(Мерлин,Артур,Да Винчи,Баба Яга,Жанна д'Арк,Аинз )
                                        <br/>Можно приобрести Геральта и Йенифер
                                        <br/>Глава 37-4
                                        <br/>Уровень аккаунта 199
                                        <br/>70 Уровень Старейшего Древа</p>
                                        <p>8 Героев 30/30 SI
                                        <br/>8 Героев 9/9 Мебель и еще несколько на подходе
                                        <br/>6 Героев 4/4 T4
                                        <br/>6 Героев 4/4 T3
                                        <br/>Все герои, у которых разблокирован SI, имеют легендарный SI +
                                        <br/>VIP 10</p>
                                    </div>
                                </Col>
                                <Col md={3}>Способ оплаты:</Col>
                                <Col md={9}>
                                    <Select name="payment" placeholder='Выбрать' classNamePrefix="react-select" options={optionsPayment} isClearable={true} isSearchable={true} />
                                </Col>
                                <Col md={3}>
                                    <button type='button' className='btn-5 w-100'>Оплатить</button>
                                </Col>
                                <Col md={9}><p className='achromat-3'>* Продавец не сможет получить оплату до тех пор, пока вы не подтвердите выполнение всех его обязательств</p></Col>
                            </Row>
                        </Col>
                        <Col xs={12} lg={5}>
