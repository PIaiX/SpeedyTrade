        ...
        <Modal show={showReview} onHide={handleCloseReview}>
            <Modal.Body>
                ...
                <form>
                    ...
                    <Select name="lot" placeholder='Выбрать' classNamePrefix="react-select" options={optionsLots} isClearable={true} isSearchable={true} />
                    ...
                    <button type='submit' className='btn-5 w-100 mt-4'>Отправить</button>
                </form>
            </Modal.Body>
        </Modal>
        </>
