            ...
            <Offcanvas show={showFav} placement={'top'} onHide={handleCloseFav}>
                <Offcanvas.Body>
                    <Container className='fav-box'>
                        <button type='button' className='d-flex me-4 mt-1' onClick={handleCloseFav}><IoArrowUpCircleOutline/></button>
                        <ul>
                            <li>
                                <img src='imgs/slider-main/wow2.jpg' alt='World of Warcraft: Shadowlands'/>
                                <Link to='/'>World of Warcraft: Shadowlands</Link>
                                <button type='button' className='d-flex'><IoCloseCircleOutline /></button>
                            </li>
                            <li>
